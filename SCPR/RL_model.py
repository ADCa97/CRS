...
def main():
    ...
    parser.add_argument('--epochs', '-me', type=int, default=10000, help='the number of RL train epoch')
    parser.add_argument('--fm_epoch', type=int, default=125, help='the epoch of FM embedding')
